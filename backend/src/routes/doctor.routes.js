...
import {createPrescription,updatePrescription,deletePrescription, getPrescriptions, getPatientPrescriptionHistory} from "../controllers/prescription.controller.js";
import {allAppointments, changeStatus, rescheduleAppointment} from "../controllers/appointment.controller.js";

const router = express.Router();

router.get("/prescription/history/:patientId",authMiddleware,checkRole(['doctor']),getPatientPrescriptionHistory);
